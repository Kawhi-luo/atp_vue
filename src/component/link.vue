<style type="text/css">
    #corTable0,#corTable,#corTable1 {
        table-layout: fixed;
    }

    #corTable0 td,#corTable td, #corTable1 td {
                ...
                if(vm.url.length > 5){
                    ...
                    .then(function(Jsondata){
                        ...
                        if(Jsondata.data && Jsondata.data.result === true){
                            ...
                            strerr+=`<tr><td width="250px">URL</td><td width="80px">Status</td><td>Error Message</td><td>Anchor Text</td><td>Resolved To</td><td>HTTP Code</td></tr>`;
                            str1+=`<tr><td width="250px">URL</td><td width="80px">Status</td><td>Anchor Text</td><td>Resolved To</td><td>HTTP Code</td></tr>`;
