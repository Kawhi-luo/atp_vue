        ...
        data(){
            return{
            	...
            	table:true,
              	...
              	collapse_one:false,
              	collapse_two:false,
              	collapse_three:false,
              	collapse_four:false,
              	collapse_five:false,
              	collapse_six:false,
              	collapse_seven:false,
              	collapse_eight:false,
              	collapse_nine:false,
              	collapse_ten:false,
              	collapse_ele:false,
              	collapse_twelve:false,
              	collapse_thirteen:false,
              	collapse_fourteen:false,
              	collapse_fifteen:false,
              	collapse_sixteen:false,
              	collapse_seventeen:false,
              	collapse_eighteen:false,
              	collapse_nineteen:false,
              	collapse_twenty:false,
              	collapse_twenty_one:false,
              	collapse_twenty_two:false
            }
        },
        methods:{
            btnImport(){
